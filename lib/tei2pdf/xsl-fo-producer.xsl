...
<!-- Stagger the pages for print but not PDF -->
  ...
  <xsl:variable name="main_font">Mona Sans</xsl:variable>
  <xsl:variable name="header_font">Poppins</xsl:variable>
  ...
  <xsl:template name="math">
    <xsl:attribute name="font-style">normal</xsl:attribute>
   <xsl:attribute name="font-family">Noto Sans Math</xsl:attribute>
  ...
  <xsl:template name="head">
    ...
    <xsl:choose>
      ...
      <xsl:when test="$output = 'pdf'">
        ...
        <xsl:attribute name="color">#1DA7E0</xsl:attribute><!-- happy yellow #ffc000-->
      </xsl:when>
    </xsl:choose>
    <xsl:attribute name="space-before">.2in</xsl:attribute>
    <xsl:attribute name="space-after">.2in</xsl:attribute>
  ...
  <xsl:template name="section_head"> <!-- For Panel, Paper, and Poster head pages-->
    ...
    <xsl:choose>
      ...
      <xsl:when test="$output = 'pdf'">
        <!--<xsl:attribute name="color">#d00011</xsl:attribute>--><!-- red -->
        <xsl:attribute name="color">#1DA7E0</xsl:attribute><!-- happy yellow -->
      </xsl:when>
    </xsl:choose>
  ...
  <xsl:template name="text">
    ...
    <!-- ALISTAIR <xsl:attribute name="font-size">9pt</xsl:attribute>-->
    <xsl:attribute name="color">black</xsl:attribute>
  </xsl:template>
...
<!-- Spezialfall: Bild in Tabelle -->
  ...
  <xsl:variable name="header_and_footer">
    <fo:static-content flow-name="before-even">
      ...
      <fo:block><xsl:call-template name="page_header"/>Digital Humanities im deutschsprachigen Raum 2023</fo:block>
    </fo:static-content>
    ...
    <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:fox="http://xmlgraphics.apache.org/fop/extensions">
      ...
      <xsl:if test="$output = 'pdf'">
        <fo:page-sequence master-reference="Full">
          <fo:flow flow-name="xsl-region-body">
            <fo:block>
                 <fo:external-graphic src="../../../input/deck/Book-of-Abstracts_Front.pdf"
      ...
      <xsl:if test="$output = 'pdf'">
        <fo:page-sequence master-reference="Full">
          <fo:flow flow-name="xsl-region-body">
            <fo:block>
              <fo:external-graphic src="../../../input/deck/Book-of-Abstracts_Back.pdf"
                                   content-width="scale-to-fit"
                                   content-height="scale-to-fit"
                                   scaling="uniform" />
            </fo:block>
      ...
      <xsl:when test="graphic/@n='intro'">
        <fo:block>
          ...
          <fo:external-graphic>
            ...
            <xsl:attribute name="src"><xsl:text>../../../input/deck/</xsl:text><xsl:value-of select="graphic/@url"/></xsl:attribute>
